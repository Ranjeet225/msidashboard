...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon" href="{{url('vendor/dashboard')}}" aria-expanded="false">
        ...
        <ul aria-expanded="false">
            ...
            <li><a href="{{url('admin/cities')}}">City</a></li>

            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Country</a>
                <ul aria-expanded="false">
                    <li><a href="{{url('admin/country')}}">Country</a></li>
                    <li><a href="{{url('admin/state')}}">State</a></li>
            ...
            {{-- <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{url('admin/owners')}}">Add Employee</a></li>
            ...
            {{-- <li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{url('admin/property-facilities')}}">Property facility</a></li>
                    <li><a href="{{url('admin/property-checklist')}}">Property CheckList</a></li>
                    <li><a href="{{url('admin/property-outdoor-features')}}">Property outdoor features</a></li>
                    <li><a href="{{url('admin/property-features')}}">Property features</a></li>
                    <li><a href="{{url('admin/wherelistproperty')}}">WhereListProperty</a></li>
                    <li><a href="{{ url('admin/nearby') }}">NearBy</a></li>
                    <li><a href="{{ url('admin/property') }}">Add Property</a></li>
                    <li><a href="{{ url('admin/propertylist') }}">Property List</a></li>
