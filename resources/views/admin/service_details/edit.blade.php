                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{route('update.service-details',[$service_details->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="title_id" id="">
                                                ...
                                                @foreach ($title as $item)
                                                   <option value="{{$item->id}}" @if ($service_details->title_id == $item->id)
                                                   @selected(true)
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" required>{!! $service_details->description !!}</textarea>
                                        </div>
                                    </div>
                                </div>
