                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="pb-3 border-bottom mb-3">
                                    <div class="d-flex mb-3 flex-wrap align-items-end">
                                        <img class="rounded me-3"
                                            src="{{ asset('admin') }}/assets/images/customers/1.jpg" width="58"
                                            alt="/">
                                        <div>
                                ...
                                <div class="pb-3 mb-3">
                                    <div class="d-flex mb-3 flex-wrap align-items-end">
                                        <img class="rounded me-3"
                                            src="{{ asset('admin') }}/assets/images/customers/2.jpg" width="58"
                                            alt="/">
                                        <div>
                                    ...
                                    <p class="fs-14 mb-0">I viewed a number of properties with Just Property and found
                                        them to be professional, efficient, patient, courteous and helpful every time.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="testimonial-one owl-carousel">
                                    <div class="items">
                                        <a href="property_details.html"><img
                                                src="{{ asset('admin') }}/assets/images/testimonial/1.png"
                                                alt="#" class="w-100 mw-100 mb-3 rounded"></a>
                                        <h5 class="fs-16 font-w600 mb-0"><a href="property_details.html"
                                        ...
                                        <p class="fs-14 mt-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
                                            enim ad mini</p>
                                    </div>
                                    <div class="items">
                                        <a href="property_details.html"><img
                                                src="{{ asset('admin') }}/assets/images/testimonial/2.png"
                                                alt="#" class="w-100 mw-100 mb-3 rounded"></a>
                                        <h5 class="fs-16 font-w600 mb-0"><a href="property_details.html"
