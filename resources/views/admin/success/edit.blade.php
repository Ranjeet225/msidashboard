            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Edit Success </h4>
                    </div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{route('update.success',[$success->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="{{$success->title}}"  class="form-control"
                                                placeholder="title" >
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number" value="{{$success->number}}"  class="form-control"
                                                placeholder="Number" >
                                                <span class="text-danger name"></span>
                                        </div>
                                    </div>
