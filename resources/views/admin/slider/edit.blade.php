                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="discription" required>{{$slider->discription}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" >
                                                <option value="1" @if ($slider->status == 1) @selected(true) @endif>Active</option>
                                                <option value="0" @if ($slider->status == 0) @selected(true) @endif>InActive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
