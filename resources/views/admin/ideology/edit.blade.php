            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Edit Ideology</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{route('update.ideology',[$ideology->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label class="form-label">Title</label>
                                            <input type="text" name="title" value="{{$ideology->title}}"  class="form-control"
                                                placeholder="title" >
