    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="mb-3">
                    <a href="{{route('create.teams')}}"
                        class="btn btn-primary btn-sm">Add Team Member</a>
                </div>
                <div class="filter cm-content-box box-primary">
                    <div class="content-title SlideToolHeader">
                        <div class="cpa">
                            <i class="fa-solid fa-file-lines me-1"></i>Team Member List
                        </div>
                    </div>
                                        ...
                                        @foreach ($teams as $item)
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a title="Edit" href="{{ route('edit.teams',[$item->id]) }}" class="btn btn-warning btn-sm content-icon">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                </td>
                                                <td class="text-nowrap">
                                                    <a title="Delete" href="{{ route('delete.teams',[$item->id]) }}" class="btn btn-warning btn-sm content-icon">
