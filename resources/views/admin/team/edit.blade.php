            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Edit  About Team Member</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{route('update.teams',[$teams->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" required>{{$teams->content}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group">
